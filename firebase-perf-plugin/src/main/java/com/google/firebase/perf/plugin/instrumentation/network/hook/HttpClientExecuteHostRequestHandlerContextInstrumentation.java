...
public class HttpClientExecuteHostRequestHandlerContextInstrumentation extends HttpClientExecuteBaseInstrumentation {
    ...
    public static class Factory implements NetworkObjectInstrumentationFactory {
        public NetworkObjectInstrumentation newObjectInstrumentation(String className, String methodName, String methodDesc) {
            return new HttpClientExecuteHostRequestHandlerContextInstrumentation();
        }
    }

    public HttpClientExecuteHostRequestHandlerContextInstrumentation() {
        super("execute", AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_HANDLER_CONTEXT);
    }
}
