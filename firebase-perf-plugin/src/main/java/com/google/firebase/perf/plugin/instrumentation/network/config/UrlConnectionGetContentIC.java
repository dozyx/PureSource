...
public class UrlConnectionGetContentIC extends NetworkObjectInstrumentationConfig {
    ...
    static {
        try {
            ...
            Method getContentMethod = URL.class.getDeclaredMethod("getContent", new Class[0]);
    ...
    public UrlConnectionGetContentIC() {
        super(new UrlConnectionGetContentInstrumentation.Factory(), CLASS_NAME, METHOD_NAME, METHOD_DESC);
    }
}
