...
public class EventBus {
    ...
    /**
     * 默认的 EventBus 构造器，字段保持默认值
     */
    private static final EventBusBuilder DEFAULT_BUILDER = new EventBusBuilder();
    private static final Map<Class<?>, List<Class<?>>> eventTypesCache = new HashMap<>();

    private final Map<Class<?>, CopyOnWriteArrayList<Subscription>> subscriptionsByEventType;// 保存观察了该 event 的所有观察者
    private final Map<Object, List<Class<?>>> typesBySubscriber;// 保存订阅者观察的所有 event 类型
    ...
    private void subscribe(Object subscriber, SubscriberMethod subscriberMethod) {
        ...
        // 创建一个订阅关系对象 Subscription
        Subscription newSubscription = new Subscription(subscriber, subscriberMethod);
        // subscriptions 保存的是所有观察该 event 的对象
